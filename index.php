...
<body>
    ...
    <script>
        function fetchSimponQuoteJSON() {

            // Feel free to download this HTML and edit it, to use another Pokemon ID

            const simpsonQuoteId = 1;

            const url = `https://simpsons-quotes-api.herokuapp.com/quotes?count=${simpsonQuoteId}`;
      ...
      <p><em>${quote[0].character}</em><p>

      <img src="${quote[0].image}"/>

    `;

                    document.querySelector('#quote').innerHTML = simpsonQuoteHtml;

                });

        }

        fetchSimponQuoteJSON()
